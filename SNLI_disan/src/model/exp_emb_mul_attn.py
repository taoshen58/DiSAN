...
class ModelExpEmbMulAttn(ModelTemplate):
    def __init__(self, token_emb_mat, glove_emb_mat, tds, cds, tl, scope):
        super(ModelExpEmbMulAttn, self).__init__(token_emb_mat, glove_emb_mat, tds, cds, tl, scope)
